...
('i', 'Iktsuarpok', 'the feeling of anticipation when you\'re expecting someone that leads you to constantly check to see if they\'re coming.', 'Inuit'),
...
(x),
('y', 'Ya\'aburnee', 'literally means \'you bury me\' but has a deeper meaning to declare your hope that your loved ones will outlive you.', 'Arabic'),
(z);
